...
def load_train_data(folder="normal", N_train_samples=[100], task="w_cs", base_folder="./"):
...
def fit_test_model(folder=["normal"], N_train_samples=[100], base_folder="./", task="w_cs", model=None, prev_folder=""):
...
def train_and_test_sequentially(folder_list=["normal"], N_train_samples_list=[100], base_folder="./", task="w_cs", iterations=10):
    model = None
    results = []
